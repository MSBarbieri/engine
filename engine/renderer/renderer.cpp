...
#pragma region validiation_layer
...
void Renderer::createSurface() {
	...
	surfaceInfo = createInfo;
}

void Renderer::setSurfaceHandler(HWND handler) {
	surfaceInfo.hwnd = handler;
}
...
VkResult Renderer::CreateDebugUtilsMessengerEXT(const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
void Renderer::DestroyDebugUtilsMessengerEXT(VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator) {
...
bool Renderer::checkDeviceExtensionSupport(VkPhysicalDevice _device) {
...
bool Renderer::isDeviceSuitable(VkPhysicalDevice _device) {
	auto indices = findQueueFamilies(_device);
